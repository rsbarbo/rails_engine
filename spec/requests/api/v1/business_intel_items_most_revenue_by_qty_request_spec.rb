...
describe "The most revenue for items" do
  it "give back the top number of merchants organized by revenue" do
    ...
    invoice_1  = Fabricate(:invoice, merchant_id: merchant_1.id)
    invoice_2 = Fabricate(:invoice, merchant_id: merchant_2.id)
    invoice_3 = Fabricate(:invoice, merchant_id: merchant_3.id)
